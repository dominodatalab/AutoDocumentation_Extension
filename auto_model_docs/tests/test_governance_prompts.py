...
class TestGovernancePrompts:
    def test_narrative_without_governance_unchanged_instructions(self):
        ...
        assert GOVERNANCE_INSTRUCTIONS not in prompt
    ...
    def test_narrative_with_governance_includes_clause(self):
        ...
        assert GOVERNANCE_INSTRUCTIONS in prompt
        assert "Governance Evidence" in prompt
        assert GOVERNANCE_NARRATIVE_NOTE in narrative_system_prompt(gov)
    ...
    def test_anti_fabrication_distinguishes_model_of_record_from_candidates(self):
        assert "[@governance.model_of_record]" in GOVERNANCE_INSTRUCTIONS
        assert "development candidates" in GOVERNANCE_INSTRUCTIONS
        assert "development history" in GOVERNANCE_NARRATIVE_NOTE.lower()
